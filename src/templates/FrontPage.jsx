        ...
        return(
            <div>
                ...
                <div className="md:absolute md:z-20 md:mt-32 flex-row space-y-0">
                    <main id="frontPage" className="md:mx-auto md:max-w-2xl px-10 py-5 md:mb-32 bg-black bg-opacity-80 text-gray-200 font-mono text-sm md:text-base font-extralight">                    
