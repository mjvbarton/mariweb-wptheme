        ...
        return(
            <div>
                ...
                <div className="md:absolute md:z-20 md:mt-32 flex-row space-y-0">
                    <main id="page" className="md:mx-32 min-h-max px-5 md:px-10 py-5 md:mb-32 bg-black bg-opacity-80 text-gray-200 font-serif font-extralight">                    
                        <h1 className="text-center font-sans font-light uppercase text-3xl my-5">Stránka</h1>                        
                            <p className="my-2">
                            ...
                            <h2 className="text-left font-sans font-light text-2xl mt-5 mb-1">Nadpis 2</h2>                        
                            <p className="my-2">
                            ...
                            <h3 className="text-left font-sans font-light text-xl mt-5 mb-1">Nadpis 3</h3>                        
                            <p className="my-2">
                            ...
                            <h4 className="text-left font-sans font-light text-lg mt-5 mb-1">Nadpis 4</h4>  
                            <p className="my-2">
                            ...
                            <h2 className="text-left font-sans font-light text-2xl mt-5 mb-1">Neřazený seznam</h2>
                            <ul className="list-inside list-disc">
                                <li>Položka 1</li>
                                <li>Položka 2</li>
                                <li>Položka 3</li>
                            </ul>
                            <h2 className="text-left font-sans font-light text-2xl mt-5 mb-1">Řazený seznam</h2>
