        ...
        return(
            <div>
                ...
                <div className="absolute z-20 mt-32 flex-row space-y-0">
                    <main id="category" className="mx-96 h-60 px-10 py-5 mb-32 bg-black bg-opacity-80 text-gray-200 font-serif font-extralight">                    
                        <h1 className="text-center font-sans font-light uppercase text-3xl my-5">Rubrika</h1>
                        <section id="description" className="text-sm">
                    ...
                    <PostContainer id="posts" title="Nejnovější články v rubrice" className="bg-white h-full p-10"/>
                    <Footer />
                </div>
            </div>
        );
